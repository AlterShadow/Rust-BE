...
|20062|UserGetStrategy|strategy_id|strategy, strategy_id, strategy_name, strategy_description, creator_user_id, social_media, historical_return, inception_time, total_amount, token_allocation, reputation, risk_score, aum, net_value, followers, approved, approved_at, backers, immutable_audit_rules, watching_wallets, aum_history, audit_rules, whitelisted_tokens|User gets a strategy|
