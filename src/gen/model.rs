...
#[derive(Serialize, Deserialize, Debug, Clone)]
#[serde(rename_all = "camelCase")]
pub struct TransferOrganizationOwnerRequest {
    pub organization_id: i64,
    pub transfer_organization_owner_key: String,
    pub new_owner_user_id: i64,
}
#[derive(Serialize, Deserialize, Debug, Clone)]
#[serde(rename_all = "camelCase")]
pub struct TransferOrganizationOwnerResponse {}
#[derive(Serialize, Deserialize, Debug, Clone)]
#[serde(rename_all = "camelCase")]
pub struct ListOrganizationMembershipRequest {}
#[derive(Serialize, Deserialize, Debug, Clone)]
#[serde(rename_all = "camelCase")]
pub struct ListOrganizationMembershipResponse {
    pub memberships: Vec<ListOrganizationMembershipRow>,
}
#[derive(Serialize, Deserialize, Debug, Clone)]
#[serde(rename_all = "camelCase")]
pub struct ListOrganizationMembershipRow {
    pub organization_id: i64,
