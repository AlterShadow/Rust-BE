    ...
    fn handle(
        ...
        async move {
            ...
            Ok(UserListStrategiesResponse {
                strategies_total: ret.first(|x| x.total).unwrap_or_default(),
                strategies: ret
                    .map_async(|v| convert_strategy_db_to_api_net_value(v, &asset_client, &db))
                    .await?,
            })
        }
        .boxed()
    ...
    fn handle(
        ...
        async move {
            ...
            Ok(UserGetStrategyResponse {
                strategy: convert_strategy_db_to_api_net_value(ret, &asset_client, &db).await?,
                watching_wallets: db
    ...
    fn handle(
        ...
        async move {
            ...
            let token_prices = list_strategy_pool_contract_asset_balances
                ...
                .collect::<Vec<_>>();
            let prices = asset_client
                .get_usd_price_latest(&token_prices)
                .await
...
pub async fn user_exit_strategy(
    ...
    let withdraw_tx_hash = execute_transaction_and_ensure_success(
    ...
    let redeem_amount = u256_to_decimal(redeem_info.amount, 18);
    update_strategy_token_balances_and_ledger_exit_strategy(
        &db,
        blockchain,
